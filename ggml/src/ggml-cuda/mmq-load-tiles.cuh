...
#if defined(AMD_MFMA_AVAILABLE) || defined(MMQ_TURING_MMA_AVAILABLE) || defined(AMD_WMMA_AVAILABLE)
    int   * x_qs = (int   *)  x_tile;
...
#endif // defined(AMD_MFMA_AVAILABLE) || defined(MMQ_TURING_MMA_AVAILABLE) || defined(AMD_WMMA_AVAILABLE)
...
#endif // defined(AMD_MFMA_AVAILABLE) || defined(MMQ_TURING_MMA_AVAILABLE)
    }
